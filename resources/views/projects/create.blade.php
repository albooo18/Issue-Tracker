    ...
    <section class="overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 shadow-xl shadow-slate-950/20 backdrop-blur lg:p-8">
        <div class="flex items-end justify-between gap-4">
            <div class="space-y-2">
                ...
                <h1 class="text-3xl font-black tracking-tight text-white sm:text-4xl">Create a project</h1>
            </div>
            <a class="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-bold text-white transition hover:bg-white/10" href="{{ route('projects.index') }}">Back</a>
        </div>
